    ...
    render() {
  		if(this.props.expanded) {
            ...
            <div className="dashboard__editBox dashboard__editBox--active">
                ...
                <button onClick={() => this._save(this, true)} className="btn btn-success"> Save </button>
                <button onClick={() => this._save(this, false)} className="btn btn-danger"> Close </button>
            </div>
        );
